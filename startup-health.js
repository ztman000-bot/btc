/* BTC Hedge Assistant v8.20.1 - persistent startup/system health registry */
(function(){'use strict';
  ...
  function checks(){return [
    ...
    {key:'researchHealth',label:'Research Health',critical:false,ok:ok(function(){return window.BTCResearchHealth})},
  ...
  window.BTCStartupHealth={version:'8.20.1',status:function(){return last||state()},render:render};
