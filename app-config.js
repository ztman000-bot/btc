...
(function(){'use strict';
  var CONFIG=Object.freeze({
    ...
    version:'8.22.2',
    architecture:'Compact Summary Home + Canonical 13-Tool Bottom Dock + Today Comprehensive Analysis + Runtime Safety Health Monitor + Single Canonical Bootstrap + Full Fail-Closed Safety + 24H Research Daemon + Confirmed-Bar Evidence + Regime Champion 2.1 + Unified Research Health + Symmetric Hedge Rotation + Reversal Intelligence',
    ...
    ui:{homeMode:'compact-summary',bottomDockRoutes:['home','scanner','position','trade','chart','risk','research','analysis','daily','settings','alerts','backtest','log'],slotRegistryVersion:'2.1'},
    modules:{
