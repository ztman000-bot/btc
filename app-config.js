...
(function(){'use strict';
  var CONFIG=Object.freeze({
    ...
    version:'8.21.1',
    architecture:'Single Canonical Bootstrap + Runtime Stability Guard + Legacy Home Quarantine + 24H Research Daemon + Safety Integration + Confirmed-Bar Evidence + Regime Champion 2.1 + Unified Research Health + Symmetric Hedge Rotation + Reversal Intelligence + Dedicated Strategy Lab Route',
    ...
    modules:{
      ...
      shell:'Modern Home + Legacy Static Dashboard Quarantine',
