/* BTC Hedge Assistant v8.8.0 - stable boot / canonical version + sidecars */
(()=>{
'use strict';
const VERSION='8.8.0';
...
function boot(){
 ...
 ensureScript('btcVersionGuard880','./version-guard.js?v=880');
 ensureScript('btcGlobalBrief868','./globalbrief-v868.js?v=880');
 ensureScript('btcAutoTop10872','./auto-top10.js?v=880');
 ensureScript('btcTop10History873','./top10-history.js?v=880');
 ensureScript('btcOpportunityV2880','./opportunity-v2.js?v=880');
