/* BTC Hedge Assistant v8.7.3 - stable boot / canonical version + sidecars */
(()=>{
'use strict';
const VERSION='8.7.3';
...
function boot(){
 ...
 ensureScript('btcVersionGuard873','./version-guard.js?v=873');
 ensureScript('btcGlobalBrief868','./globalbrief-v868.js?v=873');
 ensureScript('btcAutoTop10872','./auto-top10.js?v=873');
 ensureScript('btcTop10History873','./top10-history.js?v=873');
