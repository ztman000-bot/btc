/* BTC Hedge Assistant v8.3.3 - privacy-safe learning sidecar */
(()=>{
  'use strict';
  ...
  const appVersion=()=>document.title.match(/v([0-9.]+)/i)?.[1]||'8.3.3';
