const C='btc-hedge-v8-6-2-20260823';
...
async function injectEnhancements(r){
 ...
 let t=await r.text();
 t=t.replace(/BTC Hedge Assistant v8\.(?:3\.[123]|4\.[0-2]|5\.[0-3]|6\.[0-2])/g,'BTC Hedge Assistant v8.6.2');
 for(const v of ['V8.3.1','V8.3.2','V8.3.3','V8.4.0','V8.4.1','V8.4.2','V8.5.0','V8.5.1','V8.5.2','V8.5.3','V8.6.0','V8.6.1'])t=t.replaceAll(v,'V8.6.2');
 for(const n of ['learning','updater','dailybrief','dailybrief-fix','v850-shell','strategy-lab','globalbrief']){t=t.replace(new RegExp(n+'\\.js\\?v=\\d+','g'),n+'.js?v=862');if(!t.includes(n+'.js?v=862'))t=t.replace('</body>','<script src="./'+n+'.js?v=862" defer></script></body>')}
